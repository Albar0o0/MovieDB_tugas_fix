...
public class Main_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(Main_Activity.this).get(MovieViewModel.class);
        ...
        btn_hit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (movieId.isEmpty()){
                    ...
                    viewModel.getResultGetMovieById().observe(Main_Activity.this, showResultMovie);
    ...
    private Observer<Movies> showResultMovie = new Observer<Movies>() {
        ...
        public void onChanged(Movies movies) {
                  if (movies == null){
                      ...
                      Glide.with(Main_Activity.this).load(full_path).into(img_poster);
